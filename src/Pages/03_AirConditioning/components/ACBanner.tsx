        ...
        >
          <Stack spacing={1} sx={textStackSX}>
            ...
            <LightText
              variant="h6"
            >
              At Cam Air we can design, build, install, and <Link to={"/about"}>maintain</Link> your commercial AC system.
            </LightText>
            <LightText
              variant="h6"
            >
      Our vendor partnerships and experience allow us to provide you an air conditioning services at any budget.
            </LightText>
            <LightText
              variant="h6"
            >
              With more than 30 years experience, our highly-trained multidisciplinary team will work with you to assess your needs, address your concerns, and deliver a solution that works for you.
            </LightText>
